...
var admins = []system.SysUser{
	{TPA_MODEL: global.TPA_MODEL{ID: 1, CreatedAt: time.Now(), UpdatedAt: time.Now()}, UUID: uuid.NewV4(), Username: "admin", Password: "832c5ba281a74faae637f066243f1848", NickName: "超级管理员", HeaderImg: "http://r9qsta3s9.hn-bkt.clouddn.com/head.jpg", Phone: "15083138896", DeptId: 1, AuthorityId: 1},
}
