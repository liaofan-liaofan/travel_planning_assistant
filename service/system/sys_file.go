...
// Upload @author: [liaofan](https://github.com/liaofan-liaofan)
// @function: Upload
// @description: 创建文件上传记录
// @param: file model.ExaFileUploadAndDownload
// @return: error
func (e *FileUploadAndDownloadService) Upload(file system.SysFileUploadAndDownload) error {
	return global.TPA_DB.Create(&file).Error
}

// UploadFile @author: [liaofan](https://github.com/liaofan-liaofan)
// @function: UploadFile
