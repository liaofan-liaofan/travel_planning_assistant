...
// CreateSysOperationRecord @function: CreateSysOperationRecord
// @description: 创建记录
...
// DeleteSysOperationRecordByIds @function: DeleteSysOperationRecordByIds
// @description: 批量删除记录
// @param: ids request.IdsReq
// @return: err error
func (operationRecordService *OperationRecordService) DeleteSysOperationRecordByIds(ids request.IdsReq) (err error) {
	err = global.TPA_DB.Delete(&[]system.SysOperationRecord{}, "id in (?)", ids.Ids).Error
	return err
}

// DeleteSysOperationRecord @function: DeleteSysOperationRecord
// @description: 删除操作记录
// @param: sysOperationRecord model.SysOperationRecord
// @return: err error
func (operationRecordService *OperationRecordService) DeleteSysOperationRecord(sysOperationRecord system.SysOperationRecord) (err error) {
	err = global.TPA_DB.Delete(&sysOperationRecord).Error
	return err
}

// GetSysOperationRecord @function: DeleteSysOperationRecord
...
func (operationRecordService *OperationRecordService) GetSysOperationRecord(id uint) (err error, sysOperationRecord system.SysOperationRecord) {
	err = global.TPA_DB.Where("id = ?", id).First(&sysOperationRecord).Error
	return
}

// GetSysOperationRecordInfoList @function: GetSysOperationRecordInfoList
...
func (operationRecordService *OperationRecordService) GetSysOperationRecordInfoList(info systemReq.SysOperationRecordSearch) (err error, list interface{}, total int64) {
	...
	// 创建db
	db := global.TPA_DB.Model(&system.SysOperationRecord{})
